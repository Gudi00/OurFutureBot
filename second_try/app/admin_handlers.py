...
#
# @router.message(Command("need_to_confirm"))##сделать функция для получения всех заказов, которые ожидают выполнения
...
#     total_orders, total_income = await get_orders_summary()
#     await message.answer(f"Общее количество заказов: {total_orders}\nОбщий доход: {total_income:.2f} рублей")
# #функция для получения скидок всех пользователей
#
#
# #get_none_orders
#
